...
namespace Notifications.Test.UnitTests.Repository
{
    [TestClass]
    public class ProductRepositoryTest
    {
        ...
        {
            using (IDataContextAsync northwindFakeContext = new NotificationsFakeContext())
        ...
        {
            using (IDataContextAsync context = new NotificationsFakeContext())
