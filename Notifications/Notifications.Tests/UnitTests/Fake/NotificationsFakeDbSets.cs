...
namespace Notifications.Tests.UnitTests.Fake
{
    ...
    public class CustomerDbSet : FakeDbSet<Customer>
    {
        ...
        {
            return this.SingleOrDefault(t => t.CustomerID == (int)keyValues.FirstOrDefault());
        }
    ...
    public class SubscriberDbSet : FakeDbSet<Subscriber>
    {
        public override Subscriber Find(params object[] keyValues)
        {
            return this.SingleOrDefault(t => t.SubscriberID == (int)keyValues.FirstOrDefault());
        }

        public override Task<Subscriber> FindAsync(CancellationToken cancellationToken, params object[] keyValues)
        {
            return new Task<Subscriber>(() => this.SingleOrDefault(t => t.SubscriberID == (int)keyValues.FirstOrDefault()));
        }
    }
